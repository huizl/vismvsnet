...
# =============================================================================
# ConvNeXt V2 building blocks  (from facebookresearch/ConvNeXt-V2, official)
# =============================================================================
...
class VisMVSModel(nn.Module):
    ...
    def __init__(self, mode='soft', use_geo=False, geo_alpha=0.3,
        ...
        self.stage1 = SingleStage(use_geo=use_geo, geo_alpha=geo_alpha)
        self.stage2 = SingleStage(use_geo=use_geo, geo_alpha=geo_alpha)
        self.stage3 = SingleStage(use_geo=use_geo, geo_alpha=geo_alpha)
        self.mode = mode
