...
class VisMVSModel(nn.Module):
    def __init__(self, mode='soft', use_pid=True,
        ...
        self.stage1 = SingleStage(EdgeHead() if use_pid else None)
        self.stage2 = SingleStage(EdgeHead() if use_pid else None)
        self.stage3 = SingleStage(EdgeHead() if use_pid else None)
        self.mode = mode
