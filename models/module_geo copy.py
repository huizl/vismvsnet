...
def geometric_confidence(est_depth, ref_proj, src_proj, height, width, src_depth=None):
    ...
    return projection_visibility_confidence(est_depth, ref_proj, src_proj, height, width)
